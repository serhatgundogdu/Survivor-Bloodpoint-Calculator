...
function App() {
  ...
  const calcPoints = (point) => {
    ...
    offerings.your && lastPoint = lastPoint + (parseInt(point) * offerings.your?.perc) / 100;
    offerings.killer && lastPoint = lastPoint + (parseInt(point) * offerings.killer?.perc) / 100;
